...
import { PUT_DISPLAY_MODE } from '../../api/api';  // DisplayMode에 대한 PUT API 경로
...
const DisplayMode = ({ data, onClose }) => {
    ...
    const handleSubmit = async () => {
        ...
        if (confirmed) {
            try {
                ...
                // PUT 요청 보내기
                const response = await axios.put(PUT_DISPLAY_MODE, bodyData, {
                    params: {
