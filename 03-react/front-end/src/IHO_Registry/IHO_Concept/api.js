...
// Concept > Insert > Item.js
export const POST_MANAGEMENT_INFO = `${DEPLOY_URL}/iho-integration/concept_management_info/post/`;

// Concept > Detail > modals > Add > RSAdd.js
// Concept > Insert > Item.js
export const POST_REFERENCE_SOURCE  = `${DEPLOY_URL}/iho-integration/concept_reference_source/post/`;

// Concept > Detail > modals > Add >RAdd.js
// Concept > Insert > Item.js
export const POST_REFERENCE  =`${DEPLOY_URL}/iho-integration/concept_reference/post/`;

// Concept > Detail > modals > Update > IUpdate.js
export const PUT_ITEM_URL_IHO = `${DEPLOY_URL}/iho-integration/concept_item/put/`;

// Concept > Detail > modals > Update > MIUpdate.js
export const PUT_MI_URL =  `${DEPLOY_URL}/iho-integration/concept_management_info/put/`

// Concept > Detail > modals > Update > RSUpdate.js
export const PUT_RS_URL = `${DEPLOY_URL}/iho-integration/concept_reference_source/put/`;


// Concept > Detail > modals > Update > RUpdate.js
export const PUT_R_URL = `${DEPLOY_URL}/iho-integration/concept_reference/put/`;
