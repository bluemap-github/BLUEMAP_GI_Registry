...
const conceptTableFields = [
    ...
    { name: 'Feature Use Type', key: 'featureUseType', inputType: 'select', options: ['geographic', 'meta', 'cartographic', 'theme']} // Select 추가
];

const FeatUpdate = ({ TagItemType, data, onClose }) => {
    ...
    const handleSubmit = () => {
        ...
        if (userConfirmed) {
            ...
            axios.put(PUT_FEATURE, filteredData, {
                params: {
