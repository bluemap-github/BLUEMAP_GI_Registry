...
import {
    PUT_SYMBOL_SCHEMA,
    PUT_LINE_STYLE_SCHEMA,
    PUT_AREA_FILL_SCHEMA,
    PUT_COLOUR_PROFILE_SCHEMA,
    PUT_PIXMAP_SCHEMA
} from '../../api/api';
...
const Schema = ({ TagItemType, data, onClose }) => {
    ...
    const getApiUrl = (TagItemType) => {
        switch (TagItemType) {
            case 'SymbolSchema':
                return PUT_SYMBOL_SCHEMA;
            case 'LineStyleSchema':
                return PUT_LINE_STYLE_SCHEMA;
            case 'AreaFillSchema':
                return PUT_AREA_FILL_SCHEMA;
            case 'ColourProfileSchema':
                return PUT_COLOUR_PROFILE_SCHEMA;
            case 'PixmapSchema':
                return PUT_PIXMAP_SCHEMA;
            default:
        ...
        <div>
            ...
            <div style={{ display: 'flex', justifyContent: "space-evenly" }}>
                <div>
                    ...
                    {/* 파일 선택 필드, fileTag="Schema"로 설정 */}
                    <FileUpdate fileTag={"Schema"} data={data} onFormSubmit={(file) => onFileChange('xmlSchema', file)} />
