...
import {PUT_ENUMERATED_VALUE} from '../../api';
...
const EnumUpdate = ({ TagItemType, data, onClose }) => {
    ...
    const handleSubmit = () => {
        ...
        if (userConfirmed) {
            ...
            const { _id, attributeId, ...filteredData } = formData;
    
            console.log('Sending PUT request with:', filteredData);
            // 여기에 axios PUT 요청을 추가합니다.
            axios.put(PUT_ENUMERATED_VALUE, filteredData, {
                params: {
