...
const Navbar = () => {
  ...
  const [isIHOOpen, setIHOOpen] = useState(false);
  ...
  const toggleIHORegistryMenu = () => {
    setIHOOpen(!isIHOOpen); // IHO REGISTRY 토글 상태 변경
  };
